...
export default function FlickReelsDetailPage() {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8 pt-28 md:pt-32">
        {/* Back Button */}
        <button
          onClick={() => router.push('/')}
        ...
        {/* Main content with extra bottom spacing on desktop */}
        <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8 pb-12 md:pb-16">
          {/* Cover */}
...
function DetailSkeleton() {
  return (
    <div className="relative">
      <div className="absolute inset-0 overflow-hidden">
        <div className="w-full h-full bg-gradient-to-b from-background/50 via-background/80 to-background" />
      </div>
